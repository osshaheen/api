...
class addOrderBillingAddress extends FormRequest
{
    /**
    ...
    public function messages()
    {
        return [
            ...
            'payment_method.required'=>'حدد طريقة الدفع (1-الدفع عند الاستلام او 2- تحويل بنكي)',
            'payment_method.numeric'=>'حدد طريقة الدفع (1-الدفع عند الاستلام او 2- تحويل بنكي)',
            'payment_method.in'=>'حدد طريقة الدفع (1-الدفع عند الاستلام او 2- تحويل بنكي)',
        ];
    }
}
