...
{
    use HasFactory;
    protected $fillable = ['product_id','section_id','status','start_date','end_date'];
    ...
    public function getDiscountLimitAttribute(){
    ...
    public function getCurrentPriceAttribute(){
        return $this->product ? $this->product->current_price : '';
    }
